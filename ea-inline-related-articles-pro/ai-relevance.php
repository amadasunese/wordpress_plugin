...
/**
 * Generate inline related posts HTML
 */
function eairap_get_related_posts_html($post_id) {
    ...
    $args = [
        'post_type'      => 'post',
        'posts_per_page' => 20, // small buffer
        'post_status'    => 'publish',
        'no_found_rows'  => true,
    ...
    foreach ($query->posts as $p) {
        ...
        // Skip current post safely (VIP-friendly)
        ...
        if ($use_ai) {
            ...
            $score = eairap_similarity_score($current_text, $compare_text);
        } else {
    ...
    ob_start(); ?>
        <div class="eairap-inline-related">
            <h4><?php echo esc_html($heading); ?></h4>
            <ul class="eairap-list">
                <?php foreach ($scored_posts as $post_item): ?>
                    <li class="eairap-item">
 ...
 */
function eairap_similarity_score($text1, $text2) {
